...
classification <- metadata %>% select(samples, life_style, biosphere, ecosystem, habitat, Realm, Biome, Functional_group)
...
#ordering
taxonomic_table_subset <- taxonomic_table_subset %>% select(samples, life_style, biosphere, ecosystem, habitat, Realm, Biome, Functional_group, everything())
