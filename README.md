...
- in the [data_processing](data_processing/) folder you will find the pipelines we used to produce our final metadata. (control porpuses only)  
...
- O resultado foi a tabela [coarse_classification](data_processing/01_original_data/coarse_classification.csv) (n= 7,044);  
- No mesmo período coletamos amostras de aquíferos da plataforma NCBI e focam curadas manualmente (n = 109)  
- Resultado: [aquifer_samples](data_processing/01_original_data/aquifer_samples.csv) (n= 109);  
